...
/* package damas-0.1.0.0 */
#ifndef VERSION_damas
#define VERSION_damas "0.1.0.0"
#endif /* VERSION_damas */
#ifndef MIN_VERSION_damas
#define MIN_VERSION_damas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_damas */
...
#define CURRENT_COMPONENT_ID "damas-0.1.0.0-inplace-damas"
